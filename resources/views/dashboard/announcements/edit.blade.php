            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title pt-3">Announcements > Edit</h3>
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{route('announcements.update')}}" method="post"
                            ...
                            @csrf
                            <input type="hidden" name="id" id="announcement_id" value="{{$Announcement[0]->id}}"/>
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <label for="message">Message</label>
                                    <textarea name="message" id="message" class="form-control" rows="5" cols="80" required>{{$Announcement[0]->message}}</textarea>
                                </div>
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <div class='input-group date' id='expiration_date_time'>
                                        <input type='text' class="form-control" name="expiration_date_time" value="{{$Announcement[0]->expiration}}" autocomplete="off" />
